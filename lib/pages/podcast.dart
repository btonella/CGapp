...
class _PodcastPageState extends State<PodcastPage> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<RSSBloc>(context).add(GetEspecificRSSEvent('podcast'));
  }
    ...
    return Scaffold(
      ...
      body: BlocBuilder<RSSBloc, RSSState>(
        builder: (BuildContext context, RSSState state) {
          if (state.isLoading || state.data == null || state.data['podcast'] == null) {
            return commonTopBar(
              context,
                ...
                content: [
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: state.data['podcast'].items.length,
                      itemBuilder: (BuildContext context, int index) {
                        RssItem item = state.data['podcast'].items[index];
