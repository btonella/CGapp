...
class _VideosPageState extends State<VideosPage> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<RSSBloc>(context).add(GetEspecificRSSEvent('videos'));
  }
    ...
    return Scaffold(
      ...
      body: BlocBuilder<RSSBloc, RSSState>(
        builder: (BuildContext context, RSSState state) {
          if (state.isLoading || state.data == null || state.data['videos'] == null) {
            return commonTopBar(
              context,
                ...
                content: [
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: state.data['videos'].items.length,
                      itemBuilder: (BuildContext context, int index) {
                        RssItem item = state.data['videos'].items[index];
